...
addStage(function()
	...
	local textBox = layout:addChild(GUI.textBox(1, 1, layout.width, layout.height - 3, 0xF0F0F0, 0xCCCCCC, "Run IMineOS in S Mode?", 1, 1, 1))

	layout:addChild(inSwitchAndLabel)
end)
